...
$error = 0;
mysqli_query("create table `".$mysqli_table_prefix."sites`(
...
mysqli_query("create table `".$mysqli_table_prefix."links` (
...
mysqli_query("create table `".$mysqli_table_prefix."keywords`	(
...
mysqli_query("create table `".$mysqli_table_prefix."categories` (
...
mysqli_query("create table `".$mysqli_table_prefix."site_category` (
	site_id integer,
	category_id integer
	)");
...
mysqli_query("create table `".$mysqli_table_prefix."temp` (
	link varchar(255),
	level integer,
	id varchar (32)
	)");
...
mysqli_query("create table `".$mysqli_table_prefix."pending` (
	site_id integer,
	temp_id varchar(32),
	level integer,
	count integer,
...
mysqli_query("create table `".$mysqli_table_prefix."query_log` (
	query varchar(255),
	time timestamp(14),
	elapsed float(2),
	results int, 
